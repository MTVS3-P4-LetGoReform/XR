...
public class C_MeshVoxelizer : MonoBehaviour
{
    ...
    public virtual GameObject VoxelizeMesh()
    {
        ...
        {
            Debug.LogError("C_MeshVoxelizer : soruceGameObject is null");
            return null;
        }
        ...
        {
            Clear();
            Debug.LogError("C_MeshVoxelizer : Initialization is fail");
            return null;
        }
        if (!AnalyzeMesh())
        {
            Clear();
            Debug.LogError("C_MeshVoxelizer : AnalyzeMesh is fail");
            return null;
        }
        if (!ProcessVoxelData())
        {
            Clear();
            Debug.LogError("C_MeshVoxelizer : ProcessVoxelData is fail");
            return null;
        }
        ...
        // {
        //     Clear();
        //     Debug.LogError("C_MeshVoxelizer : FillCenterSpace is fail");
        //     return null;
        // }
    ...
    protected virtual bool Initialization()
    {
        ...
        if (m_source.mesh == null)
        {
            Debug.LogError("C_MeshVoxelizer : m_source.mesh is fail");
            return false;
        }
